...
$PAGE->set_url(new moodle_url('/local/hugo/lehrer_chats.php'));
$PAGE->set_context(\context_system::instance());
$PAGE->set_title(get_string('plugin_title_lehrer', 'local_hugo'));
$PAGE->requires->js('/local/hugo/assets/js/lehrer_chats/script.js');
$PAGE->requires->css('/local/hugo/assets/css/lehrer_chats/style.css');
...
echo $OUTPUT->render_from_template('local_hugo/lehrer_chats/index', $templatecontext);
...
echo $OUTPUT->render_from_template('local_hugo/lehrer_chats/footer', $templatecontext);
